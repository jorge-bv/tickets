...
class Clientes extends CI_Controller {
    ...
    function index() {
        ...
        $data['main_content'] = 'clientes/index_view';
        $this->load->view('shared/layout_cliente', $data);
    }
    ...
    function nueva_solicitud() {
      ...
      if (!empty($_FILES['imagen']['name'])) {
            ...
            response . redirect(base_url() . 'clientes/solicitud/' . $data['correlativo']);
        }
        ...
        $data['hidden'] = array('flag' => 1);
        $data['main_content'] = 'clientes/nueva_solicitud_view';
        $this->load->view('shared/layout_cliente', $data);
    }
    ...
    function solicitud($correlativo = 0) {
        ...
        $data['main_content'] = 'clientes/solicitud_view';
        $this->load->view('shared/layout_cliente', $data);
    }
    ...
    function guardar_comentarios() {
      ...
      redirect('clientes/solicitud/'. $post['correlativo']);
    }
    ...
    private function cambiar_estado($correlativo, $etapa_id, $estado_id, $correo) {
        ...
        response . redirect(base_url() . 'clientes/solicitud/' . $solicitud->correlativo);
    }
    ...
    private function traer_solicitudes($etapa = 0, $data) {
        ...
        $data['main_content'] = 'clientes/listado_solicitudes_view';
        $this->load->view('shared/layout_cliente', $data);
    }
