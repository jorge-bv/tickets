<!--mantenedor_clientes_listar_view.php-->
<div class="contenido_view">		
	<p></p>
	<a class="btn btn-small btn-primary" href="<?php echo base_url()?>mantenedores/clientes/nuevo">Crear Clientes <i class="icon-plus"></i></a>
	<p></p>
	...
	<table border="0" class="table table-hover">
		...
		<?php foreach($ficha as $key => $value): ?>
			<tr>
			<td><?php echo $value->hd_empresas_nombre ?></td>
...
<script type="text/javascript">
	...
	{
		document.location = '<?php echo base_url()?>mantenedores/clientes/'+id+'/'+accion;	
	}
</script>