      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="/clientes_admin">Home</a></li>
            <li class="dropdown">
    ...
    <div id="contenedor" class="container" style="">
		<div class="row clearfix">
			<div class="col-md-3 column">
				...
				<a href="<?php echo base_url() ?>clientes_admin/nueva_solicitud" class="btn btn-warning btn-lg btn-block">Crear nueva Solicitud</a>
				<br />
				<div class="list-group">
					 <a href="<?php echo base_url() ?>clientes_admin" id="inicio" class="<?php echo $active_inicio ?> list-group-item">Inicio</a>
					 <a href="<?php echo base_url() ?>clientes_admin/solicitudes_sin_procesar" id="mis-solicitudes-creadas" class="<?php echo $active_sin_procesar ?> list-group-item ">Mis solicitudes sin procesar</a>
					 <a href="<?php echo base_url() ?>clientes_admin/solicitudes_en_curso" id="mis-solicitudes-cursadas" class="<?php echo $active_en_curso ?> list-group-item">Mis solicitudes en curso</a>
           <a href="<?php echo base_url() ?>clientes_admin/solicitudes_terminadas" id="mis-solicitudes-cerradas" class="<?php echo $active_terminadas ?> list-group-item">Mis solicitudes terminadas</a>
				</div>
