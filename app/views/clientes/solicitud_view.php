<div id="contenido-der">
    ...
    <table class="table">
            ...
            <tr>
            	<td colspan="2">
            		<div class="form-group col-md-12 text-right">
						<div class="btn-group">
							<a href="<?php echo base_url().'clientes/rechazo_conforme/'.$solicitud->correlativo ?>" class="btn btn-primary tooltips">Rechazo conforme</a>
							<a data-toggle="tooltip" data-placement="right" title="Agregue un comentario indicando por qué no acepta conforme" href="<?php echo base_url().'clientes/rechazo_no_conforme/'.$solicitud->correlativo ?>" class="btn btn-danger tooltips">Rechazo No conforme</a>
						</div>
					</div>
            	</td>
            </tr>
        <?php elseif($solicitud->estados_id == 250): ?>
            ...
            <tr>
                <td colspan="2" style="width: 3px"<?php echo $solicitud->observacion_tecnica ?></td>
            </tr>
            <tr>
            	<td colspan="2">
            		<div class="form-group col-md-12 text-right">
						<div class="btn-group">
							<a href="<?php echo base_url().'clientes/cerrar_solicitud/'.$solicitud->correlativo ?>" class="btn btn-primary tooltips">Aceptar y cerrar Solicitud</a>
							<a data-toggle="tooltip" data-placement="right" title="Agregue un comentario indicando por qué no acepta conforme" href="<?php echo base_url().'clientes/proceso_no_conforme/'.$solicitud->correlativo ?>" class="btn btn-danger tooltips">No conforme</a>
						</div>
					</div>
            	</td>
            </tr>
	...
	<?php if ($solicitud->etapas_id != 30 && $solicitud->estados_id != 300): ?>
		<?php echo form_open_multipart('clientes/guardar_comentarios','id="form_comentarios"',$hidden)?>
